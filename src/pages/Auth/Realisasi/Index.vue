<template>
  <q-page class="tw-p-6">
    <div class="tw-text-3xl tw-mb-4">Realisasi</div>
    <q-card flat>
      <q-card-section>
        ...
        >
          <!-- <template #top>
            <div class="tw-flex tw-justify-between tw-w-full"></div>
          </template> -->
          ...
          <!-- <template v-slot:body="props">
            <q-tr :props="props">
              <q-td @click="props.expand = !props.expand"> </q-td>
              <q-td>
                <q-btn
                  size="sm"
                  color="primary"
...
export default defineComponent({
  ...
  methods: {
    ...
    getYear() {
      this.loading = true;
      this.$api
        .get('/forms?Limit=-&Filters={"Type": "realization"}&Sort=year asc')
        .then((res) => {
